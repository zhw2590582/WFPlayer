...
return(q=void 0,v&&m)?d(a):(m=n=void 0,p)}function j(){void 0!==q&&clearTimeout(q),s=0,m=r=n=q=void 0}function k(){return void 0===q?p:i(V())}function l(){var a=V(),c=g(a);if(m=arguments,n=this,r=a,c){if(void 0===q)return e(r);if(u)return clearTimeout(q),q=setTimeout(h,b),d(r)}return void 0===q&&(q=setTimeout(h,b)),p}var m,n,o,p,q,r,s=0,t=!1,u=!1,v=!0;if("function"!=typeof a)throw new TypeError("Expected a function");return b=na(b)||0,Q(c)&&(t=!!c.leading,u="maxWait"in c,o=u?oa(na(c.maxWait)||0,b):o,v="trailing"in c?!!c.trailing:v),l.cancel=j,l.flush=k,l}/**
   ...
   * _.toNumber('3.2');
   * // => 3.2
   */function(a){if("number"==typeof a)return a;if(ga(a))return ha;if(Q(a)){var b="function"==typeof a.valueOf?a.valueOf():a;a=Q(b)?b+"":b}if("string"!=typeof a)return 0===a?a:+a;a=a.replace(ia,"");var c=ka.test(a);return c||la.test(a)?ma(a.slice(2),c?2:8):ja.test(a)?ha:+a},oa=s,pa=r,qa=m,ra=n,sa=/*#__PURE__*/function(){function a(b){var c=this;u(this,a),this.wf=b,this.audioCtx=new(window.AudioContext||window.webkitAudioContext),this.throttleDecodeAudioData=ra(this.decodeAudioData,500),this.audiobuffer=this.audioCtx.createBuffer(2,22050,44100),this.channelData=new Float32Array,this.wf.on("loading",function(a){c.throttleDecodeAudioData(a)})}return A(a,[{key:"decodeAudioData",value:function(a){var b=this,c=this.wf.options.channel;this.audioCtx.decodeAudioData(a.buffer).then(function(a){b.audiobuffer=a,b.channelData=a.getChannelData(c),b.wf.emit("channelData",b.channelData)}).catch(function(a){d(!1,"It seems that the AudioContext decoding get wrong: ".concat(a.message.trim()))})}},{key:"destroy",value:function(){this.audiobuffer=this.audioCtx.createBuffer(2,22050,44100),this.channelData=new Float32Array}}]),a}(),ta=/*#__PURE__*/function(){function a(b){u(this,a),this.wf=b,this.fileSize=0,this.loadSize=0,this.data=new Uint8Array,this.reader=null,this.abortController=null}return A(a,[{key:"load",value:function(a){this.destroy();var b=D.kindOf(a);"string"===b?this.loadFromUrl(a):"blob"===b||"file"===b?this.loadFromFile(a):d(!1,"This format is not supported: ".concat(b))}},{key:"loadFromUrl",value:function(a){var b=this;this.abortController=new AbortController;var c=this.wf.options,d=c.withCredentials,e=c.cors,f=c.headers;return this.wf.emit("loadStart"),fetch(a,{credentials:d?"include":"omit",mode:e?"cors":"no-cors",headers:f,signal:this.abortController.signal}).then(function(a){return a.body&&"function"==typeof a.body.getReader?(b.fileSize=+a.headers.get("content-length"),b.reader=a.body.getReader(),function a(){var b=this;return this.reader.read().then(function(c){var d=c.done,e=c.value;return d?(b.wf.emit("loadEnd"),null):(b.loadSize+=e.byteLength,b.wf.emit("percentage",b.loadSize/b.fileSize),b.data=g(b.data,e),b.wf.emit("loading",b.data.slice()),a.call(b))})}.call(b)):a.arrayBuffer()}).then(function(a){if(a&&a.byteLength){var c=new Uint8Array(a);b.fileSize=c.byteLength,b.loadSize=c.byteLength,b.wf.emit("loading",c),b.wf.emit("loadEnd")}})}},{key:"loadFromFile",value:function(a){var b=this;this.reader=new FileReader,this.reader.onload=function(a){var c=new Uint8Array(a.target.result);b.fileSize=c.byteLength,b.loadSize=c.byteLength,b.wf.emit("loading",c),b.wf.emit("loadEnd"),b.reader.onload=null},this.wf.emit("loadStart"),this.reader.readAsArrayBuffer(a)}},{key:"destroy",value:function(){this.fileSize=0,this.loadSize=0,this.data=new Uint8Array,this.reader&&(this.reader.cancel(),this.reader=null),this.abortController&&(this.abortController.abort(),this.abortController=null)}}]),a}(),ua=/*#__PURE__*/function(){function a(b){var c=this;u(this,a),this.wf=b,this.playTimer=null,this.wf.on("load",function(){c.clickInit(),c.resizeInit(),c.playInit()})}return A(a,[{key:"clickInit",value:function(){var a=this,b=this.wf,c=b.template.canvas,d=b.events.proxy;d(c,["click","contextmenu"],function(b){var d=a.wf,e=d.currentTime,f=d.options,g=f.perDuration,h=f.padding,i=f.container,k=c.width/(10*g+2*h),l=j(b.pageX-i.offsetLeft-h*k,0,1/0),m=10*q(e/g),n=j(l/k/10+m,m,m+g);a.wf.emit(b.type,n,b)})}},{key:"resizeInit",value:function(){var a=this,b=this.wf,c=b.template,d=b.drawer,e=b.events.proxy,f=ra(function(){c.update(),d.update(),a.wf.emit("resize")},500);e(window,["resize","orientationchange"],function(){f()})}},{key:"playInit",value:function(){var a=this.wf,b=a.drawer,c=a.options.mediaElement;c&&function a(){var d=this;this.playTimer=requestAnimationFrame(function(){d.wf.playing&&(b.update(),d.wf.emit("playing",c.currentTime)),d.wf.destroy||a.call(d)})}.call(this)}},{key:"destroy",value:function(){cancelAnimationFrame(this.playTimer)}}]),a}(),va=0,i=[],wa=/*#__PURE__*/function(a){var c=Number.isInteger;function b(){var a,c=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};return u(this,b),a=y(this,z(b).call(this)),a._zoom=1,a._currentTime=0,a.destroy=!1,a.options={},a.setOptions(c),a.events=new F(x(a)),a.template=new L(x(a)),a.decoder=new sa(x(a)),a.drawer=new P(x(a)),a.controller=new ua(x(a)),a.loader=new ta(x(a)),va+=1,a.id=va,i.push(x(a)),a}return C(b,a),A(b,null,[{key:"instances",get:function(){return i}},{key:"version",get:function(){return"1.1.3"}},{key:"env",get:function(){return"\"production\""}},{key:"default",get:function(){return{container:"#wfplayer",mediaElement:null,waveColor:"rgba(255, 255, 255, 0.1)",backgroundColor:"rgb(28, 32, 34)",cursor:!0,cursorColor:"#ff0000",progress:!0,progressColor:"rgba(255, 255, 255, 0.5)",grid:!0,gridColor:"rgba(255, 255, 255, 0.05)",ruler:!0,rulerColor:"rgba(255, 255, 255, 0.5)",rulerAtTop:!0,withCredentials:!1,cors:!1,headers:{},pixelRatio:window.devicePixelRatio,channel:0,perDuration:10,padding:5}}},{key:"scheme",get:function(){return{container:"htmlelement",mediaElement:"null|htmlvideoelement|htmlaudioelement",waveColor:"string",backgroundColor:"string",cursor:"boolean",cursorColor:"string",progress:"boolean",progressColor:"string",grid:"boolean",gridColor:"string",ruler:"boolean",rulerColor:"string",rulerAtTop:"boolean",withCredentials:"boolean",cors:"boolean",headers:"object",pixelRatio:function(a,b){return d("number"===b,"pixelRatio is not a number"),1<=a&&c(a)},channel:function(a,b){return d("number"===b,"channel is not a number"),0<=a&&c(a)},perDuration:function(a,b){return d("number"===b,"perDuration is not a number"),1<=a&&c(a)},padding:function(a,b){return d("number"===b,"padding is not a number"),0<=a&&c(a)}}}}]),A(b,[{key:"setOptions",value:function(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};return d("object"===D.kindOf(a),"setOptions expects to receive object as a parameter"),"string"==typeof a.container&&(a.container=document.querySelector(a.container)),"string"==typeof a.mediaElement&&(a.mediaElement=document.querySelector(a.mediaElement)),this.options=D(p({},b.default,{},this.options,{},a),b.scheme),this.emit("options",this.options),this}},{key:"load",value:function(a){return(a instanceof HTMLVideoElement||a instanceof HTMLAudioElement)&&(this.options.mediaElement=a,a=a.src),d("string"==typeof a,"The load target is not a string. If you are loading a mediaElement, make sure the mediaElement.src is not empty."),this.loader.load(a),this.emit("load"),this}},{key:"seek",value:function(a){return d(!this.options.mediaElement,"If you have used mediaElement, you can't use the seek method, please use the mediaElement.currentTime property."),this._currentTime=j(a,0,this.duration),this.drawer.update(),this}},{key:"zoom",value:function(a){return d(1<=a&&c(a),"The zoom method only accepts positive integers greater than or equal to 1."),this._zoom=j(a,1,10),this.drawer.update(),this}},{key:"exportImage",value:function(){return this.template.exportImage(),this}},{key:"destroy",value:function(){this.destroy=!0,this.events.destroy(),this.template.destroy(),this.drawer.destroy(),this.controller.destroy(),this.decoder.destroy(),this.loader.destroy(),i.splice(i.indexOf(this),1)}},{key:"currentTime",get:function(){return this.options.mediaElement?this.options.mediaElement.currentTime:this._currentTime}},{key:"duration",get:function(){return this.options.mediaElement?this.options.mediaElement.duration:f("99:59:59.999")}},{key:"playing",get:function(){var a=this.options.mediaElement;return!!a&&0<a.currentTime&&!a.paused&&!a.ended&&2<a.readyState}}]),b}(E);return wa});
