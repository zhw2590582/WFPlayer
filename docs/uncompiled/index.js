...
var _workerDefault1 = parcelHelpers.interopDefault(_worker1);
class Drawer {
    constructor(wf){
        this.wf = wf;
        ...
        if (useWorker && window.OffscreenCanvas && window.Worker) {
            ...
            this.worker = (0, _workerDefault1.default);
            this.worker.postMessage({
                type: "INIT",
                data: {
                    canvas: this.canvas,
    ...
    update() {
        const { currentTime , options: { container , mediaElement , ...options } ,  } = this.wf;
...
},{}],"eDdom":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Decoder {
    constructor(wf){
