...
(function (modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    var nodeRequire =
        typeof module !== 'undefined' && typeof module.require === 'function' && module.require.bind(module);
...
})(
    {
        gEVO5: [
            function (require, module, exports) {
                ...
                class WFPlayer extends (0, _emitterDefault.default) {
                    ...
                    setOptions(options = {}) {
                        (0, _utils.errorHandle)(
                            (0, _optionValidatorDefault.default).kindOf(options) === 'object',
                    ...
                    seek(second) {
                        (0, _utils.errorHandle)(
                            ...
                            'seek expects to receive number as a parameter.',
                        );
                        ...
                        return new Promise((resolve) => {
                            ...
                            (function loop() {
                                this._seekTimer = requestAnimationFrame(() => {
                                    if (
                                        (diff > 0 && this.currentTime < clampSecond) ||
                                        (diff < 0 && this.currentTime > clampSecond)
                                    ) {
            ...
            },
            {
                ...
                './loader': '6Zr4E',
                './controller': '5fGZE',
                'bundle-text:./style.less': 'fVJDJ',
                './utils': '5vF3n',
                '@parcel/transformer-js/src/esmodule-helpers.js': '5dUr6',
            },
        ],
        '2tbdu': [
            function (require, module, exports) {
                            ...
                            (function (a, i, u) {
                                ...
                                if ('object' === r) {
                                    if ('object' !== t)
                                        throw new Error(
                                            "[Type Error]: '"
                                                .concat(u.join('.'), "' require 'object' type, but got '")
                                                .concat(t, "'"),
                                        );
                                ...
                                if ('array' === r) {
                                    if ('array' !== t)
                                        throw new Error(
                                            "[Type Error]: '"
                                                .concat(u.join('.'), "' require 'array' type, but got '")
                                                .concat(t, "'"),
                                        );
                                ...
                                throw 'string' === o
                                    ...
                                    : new Error(
                                          "[Validator Error]: The scheme for '"
                                              .concat(e.join('.'), "' validator require return true, but got '")
                                              .concat(n, "'"),
                                      );
                            }
                        }
        ...
        eG0JW: [
            ...
            { './utils': '5vF3n', '@parcel/transformer-js/src/esmodule-helpers.js': '5dUr6' },
        ],
        '5vF3n': [
            function (require, module, exports) {
                var parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
                ...
                class Drawer {
                    constructor(wf) {
                        ...
                        if (useWorker && window.OffscreenCanvas && window.Worker) {
                            this.worker = new Worker(URL.createObjectURL(new Blob([(0, _workerDefault.default)])));
                    ...
                    update() {
                        const {
                            currentTime,
                            duration: totolDuration, // eslint-disable-next-line no-unused-vars
        ...
        lPZ5X: [
            function (require, module, exports) {
                ...
                function drawWave(data) {
                    ...
                    const endIndex = Math.floor(clamp((beginTime + duration) * sampleRate, startIndex, Infinity));
                    const step = Math.floor((endIndex - startIndex) / waveWidth);
                    const cursorX = scrollable
                        ? width / 2
                        : padding * gridGap + (currentTime - beginTime) * gridGap * 10;
                    let stepIndex = 0;
                    let xIndex = 0;
                    let min = 1;
                    let max = -1;
                    for (let i = startIndex; i < endIndex; i += waveSize) {
                        ...
                        if (stepIndex >= step && xIndex < waveWidth) {
                            ...
                            ctx.fillRect(
                                ...
                                Math.max(1, (max - min) * middle * waveScale) -
                                    (waveBorder ? waveBorderWidth : 0), // Adjust the height for the border
                            );
                            xIndex += waveSize;
                            stepIndex = 0;
                            min = 1;
